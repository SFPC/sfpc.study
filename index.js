...
app.get("/about2", async (req,res) => {
  ...
  res.render("about/about2", {donors: donorData, testimonials: testimonialData, presses: pressData})
})
...
function parseClassData(apiResponse){
  ...
  if(returnObj.classType == "Weekend Intensive" || returnObj.classType?.includes("Workshop") || returnObj.classType?.includes("workshop") || returnObj.classType?.includes("Talk")) returnObj.workshop = true
